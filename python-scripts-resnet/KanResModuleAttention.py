...
class SpatialGate(nn.Module):
    ...
    def __init__(self):
        ...
        self.spatial = BasicConv(2, 1, kernel_size, stride=1, padding='same', relu=True)
...
class KanResModuleAttention(nn.Module):
    def __init__(self, in_channels, filterno_1, filterno_2, filtersize_1, filtersize_2, stride):
        ...
        self.cbam1 = CBAM(gate_channels=filterno_1, reduction_ratio=2, pool_types=['avg', 'max'], no_spatial=False)
        ...
        self.cbam2 = CBAM(gate_channels=filterno_2, reduction_ratio=2, pool_types=['avg', 'max'], no_spatial=False)
