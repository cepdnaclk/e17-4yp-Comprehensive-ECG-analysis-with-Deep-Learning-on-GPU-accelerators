...
class TransformerHelper():
    ...
    def plot_graph(self, epochs, train_losses, val_losses):
        ...
        for epoch, train_loss, val_loss in zip(epochs, train_losses, val_losses):
            writer.add_scalars(f"Transformer: Mean Absolute Loss vs Epoch [Y: {self.predict}, Learning Rate: {self.learning_rate}]", {'Training Loss':train_loss, 'Validation Loss':val_loss}, epoch)
